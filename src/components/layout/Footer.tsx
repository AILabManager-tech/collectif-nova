    ...
    <footer className="relative overflow-hidden bg-noir-900 text-gris-400">
      ...
      <div className="relative border-b border-gris-800/30 bg-gradient-to-r from-noir-900 via-noir-800 to-noir-900 px-6 py-10 text-center">
        ...
        <div className="relative z-10">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-xl bg-violet-500 px-8 py-3 font-medium text-white transition-all hover:bg-violet-600 hover:scale-[1.02] hover:shadow-lg hover:shadow-violet-500/30 glow-violet"
          >
            {nav("cta")}
          </Link>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="rounded-lg bg-violet-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-violet-600 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-noir-900"
              >
                {t("newsletter.button")}
              </button>
            </form>
